...
public class Dragon2Controller : MonoBehaviour
{
    ...
    void Update()
    {
        if (isWalking)
        {
            ...
            switch (walkDirection)
            {
                case 0:
                    if (walkCounter > walkTime / 2)
                    {
                        ...
                        anim.SetBool("Dragon2Moving", isWalking);
            ...
            if (walkCounter < 0)
            {
                GameObject clone = Instantiate(fireBall, new Vector3(myRigidBody.position.x, myRigidBody.position.y, 0), Quaternion.identity);                
                isWalking = false;
                waitCounter = waitTime;
                anim.SetBool("Dragon2Moving", isWalking);
