...
public class RaptorController : MonoBehaviour
{
            ...
            switch (walkDirection)
            {
                case 0:
                    if (walkCounter > walkTime / 2)
                    {
                        ...
                        anim.SetBool("RaptorMoving", isWalking);
    ...
    public void ChooseDirection()
    {
        ...
        //GameObject raptorShoot = (GameObject)Instantiate(raptorFire, transform.position, Quaternion.identity);
    }
}
